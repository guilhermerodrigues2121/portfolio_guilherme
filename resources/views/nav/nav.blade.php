                                ...
                                <ul id="main-menu" class="main-menu__accordion">
                                    <li class="main-menu__item">
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li class="submenu__item">
                                                <a href="index-software-development-company.html">Software development
                                                    company</a>
                                            </li>
                                            <li class="submenu__item">
                    ...
                    <div class="mxd-menu__right">
                        <div class="menu-promo">
                            <div class="menu-promo__content">
                                <p class="menu-promo__caption menu-fade-in">👋 New Rayo template is here!<br>Showcase your
                                    projects, services and expertise with impact.</p>
                                <div class="menu-promo__video">
                                    <video class="menu-video" id="inner-video" preload="auto" autoplay="autoplay"
                                        loop="loop" muted="muted"
                                        poster="https://dummyimage.com/540x310/5d5d5d/737373">
                                        <source type="video/mp4" src="{{ asset('assets/video/540x310_video.mp4') }}">
                                        <source type="video/webm" src="{{ asset('assets/video/540x310_video.webm') }}">
                                        <source type="video/ogv" src="{{ asset('assets/video/540x310_video.ogv') }}">
                                    </video>
                                </div>
                            </div>
                        </div>
