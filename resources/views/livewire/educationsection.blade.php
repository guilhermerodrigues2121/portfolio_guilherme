                ...
                <div class="row g-0">
                  <div class="col-12 col-xl-6 mxd-grid-item no-margin">
                    <div class="mxd-section-title__hrtitle anim-uni-in-up">
                      <h2 class="reveal-type">Educação  </h2>
                    </div>
                  </div>
                ...
                <div class="mxd-awards-list__inner">
                  <div class="container-fluid px-0">
                    <div class="row gx-0">
                        ...
                        <div class="mxd-awards-list__tagslist">
                          <ul>
                            <li class="anim-uni-in-up">
                              <p class="t-small">Excel</p>
                            </li>
                            <li class="anim-uni-in-up">
                              <p class="t-small">Macros</p>
                            </li>
                            <li class="anim-uni-in-up">
                              <p class="t-small">Vba</p>
                            </li>
                            <li class="anim-uni-in-up">
                              <p class="t-small">Power BI</p>
                            </li>
                          </ul>
                        </div>
                      </div>
                      <div class="col-6 col-md-6 col-xl-2 mxd-grid-item no-margin">
                        <div class="mxd-awards-list__date anim-uni-in-up">
                          <p class="t-small">2025 Abril - 2025 Novembro </p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row gx-0">
                      ...
                      <div class="col-6 col-md-6 col-xl-2 mxd-grid-item no-margin">
                        <div class="mxd-awards-list__tagslist">
                          <ul>
                            <li class="anim-uni-in-up">
                              <p class="t-small">Prompts</p>
                            </li>
                            <li class="anim-uni-in-up">
                              <p class="t-small">Agentes De IA</p>
                            </li>
                          </ul>
                        </div>
                      </div>
                      <div class="col-6 col-md-6 col-xl-2 mxd-grid-item no-margin">
                        <div class="mxd-awards-list__date anim-uni-in-up">
                          <p class="t-small">2025 Junho - 2026 Janeiro </p>
                        </div>
                      </div>
                    </div>
                  </div>
