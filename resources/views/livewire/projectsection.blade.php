<div id="projects" class="mxd-section padding-hero-06 padding-default">
                          ...
                          <div class="row g-0">
                            <div class="col-12 mxd-grid-item no-margin">
                              <div class="mxd-section-title__title">
                                <h2 class="reveal-type">Projetos</h2>
                              </div>
                            </div>
                            <div class="col-12 mxd-grid-item no-margin">
                            ...
                            <div class="col-12 mxd-grid-item no-margin">
                              <div class="mxd-section-title__controls anim-uni-in-up">
                                <a class="btn btn-anim btn-default btn-outline slide-right-up">
                                  <span class="btn-caption">Em Breve Mais Projeto</span>
                    ...
                    <div class="mxd-pinned-projects__scroll-inner mxd-grid-item no-margin">
                      ...
                      <div class="mxd-project-item">
                        <a class="mxd-project-item__media anim-uni-in-up" href="project-details.html">
                          ...
                          <div class="mxd-project-item__tags">
                            ...
                            <span class="tag tag-default tag-permanent">Streaming</span>
                          </div>
                        </a>
                        <div class="mxd-project-item__promo">
                          <div class="mxd-project-item__name">
                            <a class="anim-uni-in-up" href="project-details.html"><span>Streamit</span> Um projeto baseado na netflix</a>
                          </div>
                        </div>
                      </div>
                      <!-- item -->
                      <div class="mxd-project-item">
                        <a class="mxd-project-item__media anim-uni-in-up" href="project-details.html">
                          ...
                          <div class="mxd-project-item__tags">
                            <span class="tag tag-default tag-permanent">Landing Page</span>
                        ...
                        <div class="mxd-project-item__promo">
                          <div class="mxd-project-item__name">
                            <a class="anim-uni-in-up" href="project-details.html"><span>Accounto</span> Site Financeiro</a>
                          </div>
                        </div>
                      </div>
                      <!-- item -->
                      ...
                      <div class="mxd-project-item">
                        <a class="mxd-project-item__media anim-uni-in-up" href="project-details.html">
                          ...
                          <div class="mxd-project-item__tags">
                            <span class="tag tag-default tag-permanent">Identidade de marca</span>
                            <span class="tag tag-default tag-permanent">Assistencia de Marketing</span>
                          </div>
                        </a>
                        <div class="mxd-project-item__promo">
                          <div class="mxd-project-item__name">
