...
@section('content')
                ...
                <div class="mxd-hero-00__wrap">
                        ...
                        <div class="mxd-hero-00__title-wrap loading-wrap">
                            ...
                            <div class="mxd-hero-00__images mxd-floating-img">
                                <div class="hero-00-image image-01 mxd-floating-img__item loading__fade">
                                    <img class="mxd-pulse" src="{{ asset('assets/img/demo/01_hero-img.webp') }}"
                                        alt="Hero Image">
                                </div>
                                <div class="hero-00-image image-02 mxd-floating-img__item loading__fade">
                                    <img class="mxd-move" src="{{ asset('assets/img/demo/02_hero-img.webp') }}"
                                        alt="Hero Image">
                                </div>
                            </div>
                            <!-- title marquee -->
                            <div class="mxd-hero-00__marquee loading__item">
                                ...
                                " />
                                            ...
                                            <!-- <img class="inject-me" src="{{ asset('assets/img/icons/20x20-rayo-star.svg') }}" alt="Divider Icon"> -->
                                        </div>
                                        <!-- single item -->
                                        <div class="marquee__item item-regular text">
                                            <p>your work</p>
                    ...
                    <div class="mxd-hero-00__bottom">
                        <div class="hero-00-manifest loading__fade">
                            <p class="mxd-manifest reveal-type anim-uni-in-up">Elevate your digital presence with Rayo -
                                dynamic and stylish template designed for creative agencies and personal brands.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mxd-container">
                ...
                <div class="mxd-block">
                    <div class="mxd-demo-list">
                        ...
                        <div class="mxd-demo-list__row">
                            ...
                            <a class="mxd-demo-list__item animate-card-2" href="index-main.html" target="_blank">
                                <div class="mxd-demo-list__image">
                                    <img src="{{ asset('assets/img/demo/screens/01.webp') }}" alt="Rayo Demo Screen">
                            ...
                            <!-- single item -->
                            <a class="mxd-demo-list__item item-accent animate-card-2"
                                href="index-software-development-company.html" target="_blank">
                                <div class="mxd-demo-list__image">
                                    <img src="{{ asset('assets/img/demo/screens/02.webp') }}" alt="Rayo Demo Screen">
                        ...
                        <div class="mxd-demo-list__row">
                            <!-- single item -->
                            <a class="mxd-demo-list__item animate-card-3" href="index-freelancer-portfolio.html"
                                target="_blank">
                                <div class="mxd-demo-list__image">
                                    <img src="{{ asset('assets/img/demo/screens/03.webp') }}" alt="Rayo Demo Screen">
                            ...
                            <!-- single item -->
                            <a class="mxd-demo-list__item animate-card-3" href="index-digital-agency.html"
                                target="_blank">
                                <div class="mxd-demo-list__image">
                                    <img src="{{ asset('assets/img/demo/screens/04.webp') }}" alt="Rayo Demo Screen">
                            ...
                            <!-- single item -->
                            <a class="mxd-demo-list__item animate-card-3" href="index-creative-design-studio.html"
                                target="_blank">
                                <div class="mxd-demo-list__image">
                                    <img src="{{ asset('assets/img/demo/screens/05.webp') }}" alt="Rayo Demo Screen">
                        ...
                        <div class="mxd-demo-list__row">
                            <!-- single item -->
                            <a class="mxd-demo-list__item item-accent animate-card-2" href="index-personal-portfolio.html"
                                target="_blank">
                                <div class="mxd-demo-list__image">
                                    <img src="{{ asset('assets/img/demo/screens/06.webp') }}" alt="Rayo Demo Screen">
                            ...
                            <a class="mxd-demo-list__item animate-card-2" href="index-web-agency.html" target="_blank">
                                <div class="mxd-demo-list__image">
                                    <img src="{{ asset('assets/img/demo/screens/07.webp') }}" alt="Rayo Demo Screen">
                        ...
                        <div class="mxd-demo-list__row">
                            <!-- single item -->
                            <a class="mxd-demo-list__item animate-card-3" href="index-creative-developer.html"
                                target="_blank">
                                <div class="mxd-demo-list__image">
                                    <img src="{{ asset('assets/img/demo/screens/08.webp') }}" alt="Rayo Demo Screen">
                            ...
                            <a class="mxd-demo-list__item animate-card-3" href="index-designer.html" target="_blank">
                                <div class="mxd-demo-list__image">
                                    <img src="{{ asset('assets/img/demo/screens/09.webp') }}" alt="Rayo Demo Screen">
                                ...
                                <div class="empty-item__wrap">
                                    <div class="empty-item__content">
                                        <div class="empty-item__logo mxd-rotate">
                                            <!-- logo icon -->
                                            <svg class="empty-item__image" version="1.1"
                                                xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 56 56"
                                                ...
                                                <g>
                                                    ...
                                                    <path class="mxd-logo-colored__cat"
                                                        d="M33.6,34.5h0.9
                        ...
                        <div class="mxd-demo-cards__item card-item-left animate-card-2">
                            <div class="mxd-demo-cards__content">
                                <div class="mxd-demo-cards__descr">
                                    ...
                                    <p>A blog that looks good, reads better, and brings your stories to life beautifully.
                                    </p>
                                </div>
                            </div>
                            <div class="mxd-demo-cards__image card-image-fullwidth">
                                <img src="{{ asset('assets/img/demo/02_card-img.webp') }}" alt="Demo Card Image">
                            </div>
                        </div>
                        <!-- portfolio card -->
                        <div class="mxd-demo-cards__item card-item-right animate-card-2">
                            <div class="mxd-demo-card__gradient">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1200">
                                    ...
                                    <g>
                                        <radialGradient id="purple-radial-gr" cx="600" cy="600" r="600"
                            ...
                            <div class="mxd-demo-cards__image card-image-padding">
                                <img src="{{ asset('assets/img/demo/01_card-img.webp') }}" alt="Demo Card Image">
                            </div>
                            <div class="mxd-demo-cards__content">
                                <div class="mxd-demo-cards__descr">
                                    <h2 class="mxd-demo-cards__title h2-small">
                                    ...
                                    <div class="demo-icons__item">
                                        <div class="demo-icons__icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 56 56">
                                                <path
                                                    d="M54.8,28c0,10.6-2.8,26.8-26.8,26.8S1.2,38.6,1.2,28,4,1.2,28,1.2s26.8,16.2,26.8,26.8Z" />
                                            </svg>
                            ...
                            <div class="row g-0">
                                            ...
                                            <div class="mxd-resp-promo__content">
                                                <div class="mxd-resp-promo__manifest anim-uni-in-up">
                                                    <p class="reveal-type">Fully responsive and pixel-perfect Rayo looks
                                                        great on any device. Your site stays stunning and functional
                                                        everywhere.</p>
                                                </div>
                                ...
                                <div class="col-12 col-xl-6 mxd-resp-promo__item">
                                    <div class="mxd-resp-promo__image anim-uni-in-up">
                                        <img src="{{ asset('assets/img/demo/01_resp-img.webp') }}" alt="Rayo Image">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mxd-demo-swiper mxd-grid-item anim-uni-in-up">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide mxd-demo-swiper__slide">
                                <a class="demo-swiper-slide__image" href="services.html">
                                    <img src="{{ asset('assets/img/demo/inner/03_services.webp') }}" alt="Rayo Image">
                                </a>
                                <div class="demo-swiper-slide__descr">
                                    <a href="services.html" data-swiper-parallax-opacity="0"
                            ...
                            <!-- single slide -->
                            <div class="swiper-slide mxd-demo-swiper__slide">
                                <a class="demo-swiper-slide__image" href="team.html">
                                    <img src="{{ asset('assets/img/demo/inner/04_team.webp') }}" alt="Rayo Image">
                                </a>
                                <div class="demo-swiper-slide__descr">
                            ...
                            <!-- single slide -->
                            <div class="swiper-slide mxd-demo-swiper__slide">
                                <a class="demo-swiper-slide__image" href="pricing.html">
                                    <img src="{{ asset('assets/img/demo/inner/05_pricing.webp') }}" alt="Rayo Image">
                                </a>
                                <div class="demo-swiper-slide__descr">
                            ...
                            <!-- single slide -->
                            <div class="swiper-slide mxd-demo-swiper__slide">
                                <a class="demo-swiper-slide__image" href="about-me.html">
                                    <img src="{{ asset('assets/img/demo/inner/01_about-me.webp') }}" alt="Rayo Image">
                                </a>
                                <div class="demo-swiper-slide__descr">
                                    <a href="about-me.html" data-swiper-parallax-opacity="0"
                                        data-swiper-parallax-y="-30">
                                        <span>About Me</span>
                                    </a>
                                </div>
                            ...
                            <!-- single slide -->
                            <div class="swiper-slide mxd-demo-swiper__slide">
                                <a class="demo-swiper-slide__image" href="about-us.html">
                                    <img src="{{ asset('assets/img/demo/inner/02_about-us.webp') }}" alt="Rayo Image">
                                </a>
                                <div class="demo-swiper-slide__descr">
                                    <a href="about-us.html" data-swiper-parallax-opacity="0"
                                        data-swiper-parallax-y="-30">
                                        <span>About Us</span>
                                    </a>
                                </div>
                            ...
                            <!-- single slide -->
                            <div class="swiper-slide mxd-demo-swiper__slide">
                                <a class="demo-swiper-slide__image" href="404.html">
                                    <img src="{{ asset('assets/img/demo/inner/08_404.webp') }}" alt="Rayo Image">
                                </a>
                                <div class="demo-swiper-slide__descr">
                            ...
                            <!-- single slide -->
                            <div class="swiper-slide mxd-demo-swiper__slide">
                                <a class="demo-swiper-slide__image" href="faq.html">
                                    <img src="{{ asset('assets/img/demo/inner/06_faq.webp') }}" alt="Rayo Image">
                                </a>
                                <div class="demo-swiper-slide__descr">
                            ...
                            <!-- single slide -->
                            <div class="swiper-slide mxd-demo-swiper__slide">
                                <a class="demo-swiper-slide__image" href="contact.html">
                                    <img src="{{ asset('assets/img/demo/inner/07_contact.webp') }}" alt="Rayo Image">
                                </a>
                                <div class="demo-swiper-slide__descr">
                                    <a href="contact.html" data-swiper-parallax-opacity="0" data-swiper-parallax-y="-30">
                                        <span>Contact</span>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="mxd-block">
                        ...
                        <div class="marquee__toleft">
                            ...
                            <div class="marquee__item overflow-visible one-line item-regular text">
                                <div class="marquee__component">
                                    <img src="{{ asset('assets/img/demo/components/sec-01.webp') }}" alt="Rayo Image">
                                </div>
                            </div>
                            <!-- single item -->
                            <div class="marquee__item overflow-visible one-line item-regular text">
                                <div class="marquee__component">
                                    <img src="{{ asset('assets/img/demo/components/sec-02.webp') }}" alt="Rayo Image">
                                </div>
                            </div>
                            <!-- single item -->
                            <div class="marquee__item overflow-visible one-line item-regular text">
                                <div class="marquee__component">
                                    <img src="{{ asset('assets/img/demo/components/sec-03.webp') }}" alt="Rayo Image">
                                </div>
                            </div>
                            <!-- single item -->
                            <div class="marquee__item overflow-visible one-line item-regular text">
                                <div class="marquee__component">
                                    <img src="{{ asset('assets/img/demo/components/sec-04.webp') }}" alt="Rayo Image">
                                </div>
                            </div>
                            <!-- single item -->
                            <div class="marquee__item overflow-visible one-line item-regular text">
                                <div class="marquee__component">
                                    <img src="{{ asset('assets/img/demo/components/sec-05.webp') }}" alt="Rayo Image">
                                </div>
                            </div>
                            <!-- single item -->
                            <div class="marquee__item overflow-visible one-line item-regular text">
                                <div class="marquee__component">
                                    <img src="{{ asset('assets/img/demo/components/sec-06.webp') }}" alt="Rayo Image">
                                </div>
                            </div>
                            <!-- single item -->
                            <div class="marquee__item overflow-visible one-line item-regular text">
                                <div class="marquee__component">
                                    <img src="{{ asset('assets/img/demo/components/sec-07.webp') }}" alt="Rayo Image">
                                </div>
                            </div>
                            <!-- single item -->
                            <div class="marquee__item overflow-visible one-line item-regular text">
                                <div class="marquee__component">
                                    <img src="{{ asset('assets/img/demo/components/sec-08.webp') }}" alt="Rayo Image">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mxd-demo-components">
                            <div class="mxd-demo-components__objects">
                                <div class="mxd-demo-components__object obj-01 anim-uni-in-up">
                                    <img class="mxd-move-slow" src="{{ asset('assets/img/demo/01_comp-img.webp') }}"
                                        alt="Rayo Image">
                                </div>
                                <div class="mxd-demo-components__object obj-02 anim-uni-in-up">
                                    <img class="mxd-rotate-slow" src="{{ asset('assets/img/demo/01_comp-img.webp') }}"
                                        alt="Rayo Image">
                                </div>
                                <div class="mxd-demo-components__object obj-03 anim-uni-in-up">
                                    <img class="mxd-move" src="{{ asset('assets/img/demo/01_comp-img.webp') }}"
                                        alt="Rayo Image">
                                </div>
                            </div>
                    ...
                    <div class="marquee marquee-right--gsap muted-extra">
                        <div class="marquee__toright">
                            ...
                            <div class="marquee__item overflow-visible one-line item-regular text">
                                <div class="marquee__component">
                                    <img src="{{ asset('assets/img/demo/components/sec-09.webp') }}" alt="Rayo Image">
                                </div>
                            </div>
                            <!-- single item -->
                            <div class="marquee__item overflow-visible one-line item-regular text">
                                <div class="marquee__component">
                                    <img src="{{ asset('assets/img/demo/components/sec-10.webp') }}" alt="Rayo Image">
                                </div>
                            </div>
                            <!-- single item -->
                            <div class="marquee__item overflow-visible one-line item-regular text">
                                <div class="marquee__component">
                                    <img src="{{ asset('assets/img/demo/components/sec-11.webp') }}" alt="Rayo Image">
                                </div>
                            </div>
                            <!-- single item -->
                            <div class="marquee__item overflow-visible one-line item-regular text">
                            ...
                            <div class="marquee__item overflow-visible one-line item-regular text">
                                <div class="marquee__component">
                                    <img src="{{ asset('assets/img/demo/components/sec-14.webp') }}" alt="Rayo Image">
                                </div>
                            </div>
                            <!-- single item -->
                            <div class="marquee__item overflow-visible one-line item-regular text">
                            ...
                            <div class="marquee__item overflow-visible one-line item-regular text">
                                <div class="marquee__component">
                                    <img src="{{ asset('assets/img/demo/components/sec-15.webp') }}" alt="Rayo Image">
                                </div>
                            </div>
                            <!-- single item -->
                            <div class="marquee__item overflow-visible one-line item-regular text">
                            ...
                            <div class="row g-0">
                                    ...
                                    <div class="mxd-container grid-container no-padding-right">
                                        <div class="mxd-block mxd-grid-item no-margin">
                                            <div class="mxd-features-promo__content">
                                                <h2
                                                    class="mxd-pinned__title centered-mobile h2-small anim-uni-in-up reveal-type">
                                                    Top-notch features, build for you</h2>
                                                ...
                                                <p class="anim-uni-in-up centered-mobile">Rayo template packed with smooth
                                                    animations, modern design
                                                    tools and clean code. It's a flexible, future-proof template that's easy
                                                    to customize
                                                    and a joy to use.</p>
                                            </div>
                                        </div>
                                ...
                                <div class="col-12 col-xl-7 mxd-features-promo__item">
                                    <div class="mxd-features-promo__image anim-uni-in-up">
                                        <img src="{{ asset('assets/img/demo/01_fea-img.webp') }}" alt="Rayo Image">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mxd-features-cards">
                        <div class="container-fluid px-0">
                            <div class="row gx-0">
                                <!-- item -->
                                <div
                                    class="col-12 col-xl-8 mxd-features-cards__item features-item-01 mxd-grid-item anim-uni-scale-in-right">
                                    <div class="mxd-features-cards__inner justify-between bg-base-tint radius-l padding-4">
                                        <div class="mxd-features-cards__gradient features-gradient-01">
                                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <g>
                                                    <radialGradient id="purple-radial-grad" cx="600" cy="600"
                                                        r="600" gradientUnits="userSpaceOnUse">
                                                        <stop offset="0"
                                                            style="stop-color:#9F8BE7;stop-opacity:0.6" />
                                                        <stop offset="1" style="stop-color:#9F8BE7;stop-opacity:0" />
                                                    </radialGradient>
                                                    <circle class="mxd-card-bg" cx="600" cy="600" r="600" />
                                                </g>
                                        ...
                                        <div class="mxd-features-cards__image features-image-01">
                                            <img src="{{ asset('assets/img/demo/02_fea-img.webp') }}"
                                        ...
                                        <div class="mxd-features-cards__info">
                                            ...
                                            <p class="anim-uni-in-up">Modern, eye-catching layouts crafted to make your
                                                brand stand
                                ...
                                <div class="col-12 col-xl-4 mxd-features-cards__item mxd-grid-item anim-uni-scale-in-left">
                                    <div class="mxd-features-cards__inner justify-end bg-accent radius-l padding-4">
                                        <div class="mxd-features-cards__image features-image-02">
                                            <img src="{{ asset('assets/img/demo/03_fea-img.webp') }}"
                                                alt="Rayo Illustration">
                                        </div>
                                        <div class="mxd-features-cards__title">
                                        ...
                                        <div class="mxd-features-cards__info">
                                            <div class="mxd-features-cards__tags">
                                                <span class="tag tag-default tag-outline-opposite anim-uni-in-up">Theme
                                                    Choice</span>
                                                <span
                                                    class="tag tag-default tag-outline-opposite anim-uni-in-up">Interactive</span>
                                            </div>
                                            <p class="t-opposite anim-uni-in-up">Switch effortlessly between light and dark
                                                modes
                                ...
                                <!-- item -->
                                <div
                                    class="col-12 col-xl-4 mxd-features-cards__item mxd-grid-item anim-uni-scale-in-right">
                                    <div class="mxd-features-cards__inner bg-additional radius-l padding-4">
                                        ...
                                        <div class="mxd-features-cards__info">
                                            <div class="mxd-features-cards__tags">
                                                ...
                                                <span
                                                    class="tag tag-default tag-outline anim-uni-in-up">User-friendly</span>
                                            </div>
                                            <p class="t-bright anim-uni-in-up">Adapt every detail to fit your vision — no
                                                fuss, just
                                                simple, clear editing.</p>
                                        </div>
                                        <div class="mxd-features-cards__image features-image-03">
                                            <img src="{{ asset('assets/img/demo/04_fea-img.webp') }}" alt="Illustration">
                                        </div>
                                    </div>
                                </div>
                                <!-- item -->
                                <div class="col-12 col-xl-4 mxd-features-cards__item mxd-grid-item anim-uni-scale-in">
                                    <div class="mxd-features-cards__inner bg-base-opp radius-l padding-4">
                                        ...
                                        <div class="mxd-features-cards__info">
                                            <div class="mxd-features-cards__tags">
                                                <span
                                                    class="tag tag-default tag-outline-opposite anim-uni-in-up">Motion</span>
                                                <span
                                                    class="tag tag-default tag-outline-opposite anim-uni-in-up">Smooth</span>
                                                <span
                                                    class="tag tag-default tag-outline-opposite anim-uni-in-up">Interactive</span>
                                            </div>
                                            <p class="t-opposite anim-uni-in-up">Adding unique movement, scroll magic, and
                                                creative
                                                depth to your pages.</p>
                                        </div>
                                        <div class="mxd-features-cards__image features-image-04">
                                            <img src="{{ asset('assets/img/demo/06_fea-img.webp') }}" alt="Illustration">
                                        </div>
                                    </div>
                                </div>
                                <!-- item -->
                                    ...
                                    <div class="mxd-features-cards__inner justify-end bg-base-tint radius-l padding-4">
                                        <div class="mxd-features-cards__gradient features-gradient-02">
                                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <g>
                                                    <radialGradient id="purple-radial-gradient" cx="600"
                                                        cy="600" r="600" gradientUnits="userSpaceOnUse">
                                                        <stop offset="0"
                                                            style="stop-color:#9F8BE7;stop-opacity:0.6" />
                                                        <stop offset="1" style="stop-color:#9F8BE7;stop-opacity:0" />
                                                    </radialGradient>
                                        ...
                                        <div class="mxd-features-cards__info">
                                            ...
                                            <p class="anim-uni-in-up">Built with clean, well-structured code that's fast,
                                                secure,
                                                and easy to maintain.</p>
                                        </div>
                                        <div class="mxd-features-cards__image features-image-05">
                                            <img src="{{ asset('assets/img/demo/05_fea-img.webp') }}" alt="Illustration">
                                        </div>
                                    </div>
                                </div>
                                <!-- teaser -->
                ...
                <div class="mxd-block">
                    <div class="mxd-demo-cta">
                        ...
                        <div class="mxd-demo-cta__btn anim-uni-in-up">
                            <a class="btn btn-anim btn-default btn-large btn-additional slide-right"
    ...
    <footer class="mxd-demo-footer">
        ...
        <div class="mxd-demo-footer__bg">
            <img src="{{ asset('assets/img/demo/01-footer.webp') }}" alt="Rayo Image">
        </div>
                        ...
                        <div class="col-12 col-xl-3 mxd-demo-footer__item mxd-grid-item">
                            <div class="mxd-demo-footer__logo anim-uni-in-up">
                                <a href="#0" class="mxd-logo">
                                    <!-- logo icon -->
                                    <svg class="mxd-logo__image" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                        x="0px" y="0px" viewBox="0 0 56 56" style="enable-background:new 0 0 56 56;"
                                        xml:space="preserve">
                                        <style type="text/css">
                                            .mxd-logo__bg {
                                                fill: var(--base-opp);
                                        ...
                                        <path class="mxd-logo__bg"
                                            d="M56,28c0,11.1-2.9,28-28,28S0,39.1,0,28S2.9,0,28,0S56,16.9,56,28z" />
                                        <g>
                                            <defs>
                                                <path id="mxd-logo__clippath-2"
                                                    d="M28,0C2.9,0,0,16.9,0,28s2.9,28,28,28s28-16.9,28-28S53.1,0,28,0z" />
                                            </defs>
                            ...
                            <div class="mxd-demo-footer__slogan anim-uni-in-up">
                                <p class="t-small t-bright">👋 New Rayo template is here! Showcase your projects, services
                                    and expertise with impact.</p>
                            </div>
                            <div class="mxd-demo-footer__btn anim-uni-in-up">
                                <a class="btn btn-anim btn-default btn-small btn-accent slide-right"
                                    href="https://1.envato.market/kOvmWN" target="_blank">
                                    <span class="btn-caption">Buy Now</span>
                                    ...
                                    <div class="row g-0">
                                        <div class="col-12 col-md-4 mxd-grid-item mxd-footer-nav__item">
                                            <div class="mxd-footer-nav__block">
                                                ...
                                                <div class="mxd-footer-nav__list">
                                                    <ul>
                                                        <li><a class="anim-uni-in-up" href="index-main.html">Main home</a>
                                                        </li>
                                                        <li><a class="anim-uni-in-up"
                                                                href="index-software-development-company.html">Software
                                                                development company</a></li>
                                                        <li><a class="anim-uni-in-up"
                                                                href="index-freelancer-portfolio.html">Freelanser
                                                                portfolio</a></li>
                                                        <li><a class="anim-uni-in-up"
                                                                href="index-digital-agency.html">Digital agency</a></li>
                                                        <li><a class="anim-uni-in-up"
                                                                href="index-creative-design-studio.html">Creative design
                                                                studio</a></li>
                                                        <li><a class="anim-uni-in-up"
                                                                href="index-personal-portfolio.html">Personal portfolio</a>
                                                        </li>
                                                        <li><a class="anim-uni-in-up" href="index-web-agency.html">Web
                                                                agency</a></li>
                                                        <li><a class="anim-uni-in-up"
                                                                href="index-creative-developer.html">Creative developer</a>
                                                        </li>
                                                        <li><a class="anim-uni-in-up"
                                                                href="index-designer.html">Designer</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-4 mxd-grid-item mxd-footer-nav__item">
                                            <div class="mxd-footer-nav__block">
                                                ...
                                                <div class="mxd-footer-nav__list">
                                                    <ul>
                                                        <li><a class="anim-uni-in-up" href="works-simple.html">Works
                                                                simple</a></li>
                                                        <li><a class="anim-uni-in-up" href="works-masonry.html">Works
                                                                masonry</a></li>
                                                        <li><a class="anim-uni-in-up" href="project-details.html">Project
                                                                details</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="mxd-footer-nav__block">
                                                ...
                                                <div class="mxd-footer-nav__list">
                                                    <ul>
                                                        <li><a class="anim-uni-in-up" href="blog-standard.html">Blog
                                                                standard</a></li>
                                                        <li><a class="anim-uni-in-up" href="blog-creative.html">Blog
                                                                creative</a></li>
                                                        <li><a class="anim-uni-in-up" href="blog-article.html">Single
                                                                post</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 col-md-4 mxd-grid-item mxd-footer-nav__item">
                                            <div class="mxd-footer-nav__block">
                                                ...
                                                <div class="mxd-footer-nav__list">
                                                    <ul>
                                                        <li><a class="anim-uni-in-up" href="about-me.html">About me</a>
                                                        </li>
                                                        <li><a class="anim-uni-in-up" href="about-us.html">About us</a>
                                                        </li>
                                                        <li><a class="anim-uni-in-up" href="services.html">Services</a>
                                                        </li>
                                                        <li><a class="anim-uni-in-up" href="team.html">Our team</a></li>
                                                        <li><a class="anim-uni-in-up" href="pricing.html">Pricing
                                                                plans</a></li>
                                                        <li><a class="anim-uni-in-up" href="faq.html">Frequently asked
                                                                questions</a></li>
                                                        <li><a class="anim-uni-in-up" href="404.html">404 error page</a>
                                                        </li>
                                                        <li><a class="anim-uni-in-up" href="contact.html">Contact</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                        ...
                        <div class="col-12 col-xl-3 mxd-demo-footer__item mxd-grid-item">
                            <div class="mxd-demo-footer__promo">
                                ...
                                <div class="mxd-footer-promo__list">
                                    <a class="mxd-footer-promo__item" href="https://1.envato.market/rQ5AQD"
                                        target="_blank">
                                        <img class="mxd-footer-promo__icon anim-uni-in-up"
                                            src="{{ asset('assets/img/demo/icon-blayden.webp') }}"
                                            alt="Blayden - Personal Portfolio & Resume HTML Template">
                                        <span class="mxd-footer-promo__link anim-uni-in-up">Blayden - Personal Portfolio &
                                            Resume HTML Template</span>
                                    </a>
                                    <a class="mxd-footer-promo__item" href="https://1.envato.market/9gBzn0"
                                        target="_blank">
                                        <img class="mxd-footer-promo__icon anim-uni-in-up"
                                            src="{{ asset('assets/img/demo/icon-ignite.webp') }}"
                                            alt="Ignite - Portfolio and Landing Page Template">
                                        <span class="mxd-footer-promo__link anim-uni-in-up">Ignite - Portfolio and Landing
                                            Page Template</span>
                                    </a>
                                    <a class="mxd-footer-promo__item" href="https://1.envato.market/anoYGQ"
                                        target="_blank">
                                        <img class="mxd-footer-promo__icon anim-uni-in-up"
                                            src="{{ asset('assets/img/demo/icon-braxton.webp') }}"
                                            alt="Braxton - Personal Portfolio & Resume HTML Template">
                                        <span class="mxd-footer-promo__link anim-uni-in-up">Braxton - Personal Portfolio &
                                            Resume HTML Template</span>
                                    </a>
                                </div>
                            </div>
